...
export const productionApi = {
  ...
  assignPlate: (arrangeId: string, plateNo: number, plateName: string) =>
    api.post<{ assigned: boolean; plateName: string | null }>("/production/plates/assign", { arrangeId, plateNo, plateName }),

  releasePlate: (arrangeId: string, plateNo: number) =>
    api.post<{ released: boolean; plateName: string | null }>("/production/plates/release", { arrangeId, plateNo }),
